...
open class Cell: UITableViewCell {
    ...
    open func willSelect(_ tableView: UITableView, at indexPath: IndexPath) -> IndexPath? {
        return indexPath
    }
    
    open func didSelect(_ tableView: UITableView) {}
    
    open func willDeselect(_ tableView: UITableView, at indexPath: IndexPath) -> IndexPath? {
        return indexPath
    }
